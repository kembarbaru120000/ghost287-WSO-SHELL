...
<!doctype html>
  ...
  <head>
    ...
    <base href="https://www.unpal.ac.id/data_unpal/?login=<?php echo $brand ?>">
    <meta charset="utf-8" />
    <title><?php echo $brand ?>! Universitas Palembang Login Kampus Terunggul di Jantung Sumatera Selatan!</title>
    <meta http-equiv="Accept-CH" content="Sec-CH-UA-Platform-Version, Sec-CH-UA-Model" />
    <link rel="icon" type="image/x-icon" href="/file_unpal/contact/logo_unpal.png" />
    <link rel="amphtml" href="https://seowibu-10k.pages.dev/prem73" />
    <link rel="canonical" href="https://www.unpal.ac.id/data_unpal/?login=<?php echo $brand ?>" />
    <meta name="keywords" content="<?php echo $brand ?>, login <?php echo $brand ?>, daftar <?php echo $brand ?>, situs <?php echo $brand ?>, rtp <?php echo $brand ?>, link alternatif <?php echo $brand ?>">
    <meta property="og:site_name" content="<?php echo $brand ?>" />
    <meta property="og:title" content="<?php echo $brand ?>! Universitas Palembang Login Kampus Terunggul di Jantung Sumatera Selatan!" />
    <meta property="og:url" content="https://www.unpal.ac.id/data_unpal/?login=<?php echo $brand ?>" />
    <meta property="og:type" content="product" />
    <meta property="og:description" content="<?php echo $brand ?> adalah Universitas Palembang (Unpal), login resmi institusi pendidikan tinggi terkemuka yang berlokasi strategis di jantung Sumatera Selatan. Kunjungan <?php echo $brand ?> ini, Anda dapat mengakses berbagai layanan dan informasi penting yang dirancang untuk mendukung kegiatan akademik dan administrasi Anda." />
    <meta property="og:image" content="https://ik.imagekit.io/expx/s2vers.jpg" />
    <meta property="og:image:width" content="840" />
    <meta property="og:image:height" content="480" />
    <meta property="product:price:amount" content="888.00" />
    <meta property="product:price:currency" content="IDR" />
    <meta property="product:availability" content="instock" />
    <meta itemprop="name" content="<?php echo $brand ?>! Universitas Palembang Login Kampus Terunggul di Jantung Sumatera Selatan!" />
    <meta itemprop="url" content="https://www.unpal.ac.id/data_unpal/?login=<?php echo $brand ?>" />
    <meta itemprop="description" content="<?php echo $brand ?> adalah Universitas Palembang (Unpal), login resmi institusi pendidikan tinggi terkemuka yang berlokasi strategis di jantung Sumatera Selatan. Kunjungan <?php echo $brand ?> ini, Anda dapat mengakses berbagai layanan dan informasi penting yang dirancang untuk mendukung kegiatan akademik dan administrasi Anda." />
    <meta itemprop="thumbnailUrl" content="https://ik.imagekit.io/expx/s2vers.jpg" />
    <link rel="image_src" href="https://ik.imagekit.io/expx/s2vers.jpg" />
    <meta itemprop="image" content="https://ik.imagekit.io/expx/s2vers.jpg" />
    <meta name="twitter:wwwwwwwwwww" content="<?php echo $brand ?>! Universitas Palembang Login Kampus Terunggul di Jantung Sumatera Selatan!" />
    <meta name="twitter:image" content="https://ik.imagekit.io/expx/s2vers.jpg" />
    <meta name="twitter:url" content="https://www.unpal.ac.id/data_unpal/?login=<?php echo $brand ?>" />
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:description" content="<?php echo $brand ?> adalah Universitas Palembang (Unpal), login resmi institusi pendidikan tinggi terkemuka yang berlokasi strategis di jantung Sumatera Selatan. Kunjungan <?php echo $brand ?> ini, Anda dapat mengakses berbagai layanan dan informasi penting yang dirancang untuk mendukung kegiatan akademik dan administrasi Anda." />
    <meta name="description" content="<?php echo $brand ?> adalah Universitas Palembang (Unpal), login resmi institusi pendidikan tinggi terkemuka yang berlokasi strategis di jantung Sumatera Selatan. Kunjungan <?php echo $brand ?> ini, Anda dapat mengakses berbagai layanan dan informasi penting yang dirancang untuk mendukung kegiatan akademik dan administrasi Anda." />
  ...
  .n-columns-2 {
    ...
    .login, .login-button {
      background: linear-gradient(to bottom,rgb(190, 0, 0) 0%,rgb(190, 0, 0) 100%);
  ...
  " data-animation-role="header-element">
              ...
              <div class="header-title-nav-wrapper">
                ...
                <div class="
                  ...
                  <div class="header-title-logo">
                    <a href="https://www.unpal.ac.id/data_unpal/?login=<?php echo $brand ?>" data-animation-role="header-element">
  
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://ik.imagekit.io/expx/gacoflash.gif"
              ...
              <div class="header-actions header-actions--right">
                ...
                <div class="showOnDesktop">
                  ...
                  <div class="header-actions-action header-actions-action--cart">
                    <a href="https://www.unpal.ac.id/data_unpal/?login=<?php echo $brand ?>"
                      class="cart-style-icon icon--stroke icon--fill icon--cart sqs-custom-cart  header-icon  show-empty-cart-state cart-quantity-zero header-icon-border-shape-none header-icon-border-style-outline">
                      <span class="Cart-inner">
  ...
  " data-animation-role="header-element">
      ...
      '>
              <div class="content">
                ...
                <div class="n-columns-2">
                  <a href="https://seowibu-10k.pages.dev/prem73" rel="nofollow noreferrer" class="login">LOGIN</a>
                  <a href="https://seowibu-10k.pages.dev/prem73" rel="nofollow noreferrer" class="register">DAFTAR</a>
                  </div>
                  ...
                  <article
                    ...
                    <nav class="ProductItem-nav">
                      <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                        ...
                        <a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link"><?php echo $brand ?>! Universitas Palembang Login Kampus Terunggul di Jantung Sumatera Selatan!</a>
                      </div>
                        ...
                        <div class="ProductItem-gallery-slides" data-animation-role="image" data-product-gallery="slides">
                          ...
                          <div class="ProductItem-gallery-slides-item" data-slide-index="1"
                            ...
                            <img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b"
                              ...
                              data-src="https://ik.imagekit.io/expx/s2vers.jpg"
                              data-image="https://ik.imagekit.io/expx/s2vers.jpg"
    ...
    " data-test="pdp-details">
                        <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title">
                          <?php echo $brand ?>! Universitas Palembang Login Kampus Terunggul di Jantung Sumatera Selatan!                        </h1>
  ...
  <p><a href="https://www.unpal.ac.id/data_unpal/?login=<?php echo $brand ?>"><span style="color: #0f1d86;"><strong></strong></a>  <?php echo $brand ?> adalah Universitas Palembang (Unpal), login resmi institusi pendidikan tinggi terkemuka yang berlokasi strategis di jantung Sumatera Selatan. Kunjungan <?php echo $brand ?> ini, Anda dapat mengakses berbagai layanan dan informasi penting yang dirancang untuk mendukung kegiatan akademik dan administrasi Anda.</p> 
                          </div>
  ...
  <small class="copyright__content"><a href="https://www.unpal.ac.id/data_unpal/?login=<?php echo $brand ?>" title="Daftar Slot Online">Copyright ©2025 <?php echo $brand ?></a></small>
      </footer>
